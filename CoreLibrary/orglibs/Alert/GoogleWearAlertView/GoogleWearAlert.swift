...
public enum GoogleWearAlertType {
    case Message
    case Warning
    case Error
    case Success
...
public enum GoogleWearAlertPosition {
    case Top
    case Center
    case Bottom
}

public class GoogleWearAlert: NSObject {
    
    //Singleon Class (Only needed for internal use)
    public class var sharedInstance: GoogleWearAlert {
    struct Static {
    ...
    public class func showAlert(title title:String, type:GoogleWearAlertType) {
        showAlert(title:title, image: nil, type: type, inViewController: GoogleWearAlert.sharedInstance.useDefaultController())
    }
    
    public class func showAlert(title title:String, image:UIImage?, type:GoogleWearAlertType, duration:Double = 2.5, inViewController:UIViewController) {
    ...
    public class func showAlert(title title:String, image:UIImage?, type:GoogleWearAlertType, duration:Double, inViewController:UIViewController, atPostion:GoogleWearAlertPosition, canBeDismissedByUser:Bool) {
    ...
    func presentAlert() {
        ...
        let windowFrame = UIScreen.mainScreen().applicationFrame
